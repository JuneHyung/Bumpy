...
const userForm: Ref<UserFormData> = ref({
  ...
  password: { value:'', placeholder: '변경할 비밀번호를 영문, 숫자, 특수문자를 1자이상 포함해 8~20자로 입력해주세요.', disabled: true, maxlength: 20 },
  ...
  phoneFirst: { value: '', placeholder: '000', isNumber:true, maxlength: 3 },
  phoneSecond: { value: '', placeholder: '0000', isNumber:true, maxlength: 4 },
  phoneThird: { value: '', placeholder: '0000', isNumber:true, maxlength: 4 },
