...
/**
 * DTO for {@link com.bump.bumpy.database.entity.data.DataHWeight}
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
@Accessors(chain = true)
public class WeightResponseDto implements Serializable {
    @NotNull
    ...
    public WeightResponseDto(DataHWeight entity) {
